...
class LinkHeaderMixin:
    def get_headers(self):
        ...
        if isinstance(self, PageNumberPagination):
            links = (
                *links,
...
class LinkHeaderPagination(PageNumberPagination, LinkHeaderMixin):
...
class LinkHeaderCursorPagination(CursorPagination, LinkHeaderMixin):
    """
...
class LinkHeaderJsonKeyCursorPagination(CursorPagination, LinkHeaderMixin):
    """
    Provides cursor pagination with standard json key pagination links
    in addition to LinkHeader.
    """
